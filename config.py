...
logging_arg.add_argument('--model_nb', type=str, default="1", help='path to latest checkpoint')
# -----------------------------------------------------------------------------
# Network
...
net_arg.add_argument("--GNN_layers", default= ['self', 'cross'] * 6, help="number of layers for self and cross attention")
...
data_arg.add_argument("--data_dir", type=str, default="./dataset", help="dir of dataset")
data_arg.add_argument("--dataset", type=str, default="semantic3D", help="used dataset")
...
train_arg.add_argument("--train_epoches", type=int, default=400, help="maximum training iterations to perform")
